...
<html lang="en">
      ...
      <nav class="navbar navbar-expand-md " >
        ...
        <button  class="navbar-toggler" type="button" data-toggle="collapse" data-target="#nav" >
         ...
         <div class="dropdown-menu">
             <a class="dropdown-item" href="#RE">Mots du Directeur</a>
             <a class="dropdown-item" href="#Dé">Organigramme</a>
             <a class="dropdown-item" href="#Dé">Equipes</a>
         </div>
        </li>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="peda1.jpg" class="d-block w-100" alt="...">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <h3 class="bien">Présentation</h3> 
    <div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title" style="text-align:center;">Mots du Directeur</h5>
  ...
  <div class="col" >
    <div class="card" style="height:680px">
      ...
      <div class="card-body">
      <h5 class="card-title" style="text-align:center;">Organigramme</h5>
      </div>
      <img src="orga.png" class="card-img-top" alt="..." style="height:400px;margin-bottom:150px">
    </div>
  </div>
  ...
  <div class="card" style="width:400px;margin:20px;">
    <img class="card-img-top" src="gei.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
  ...
  <div class="card" style="width:400px;margin:20px;">
    <img class="card-img-top" src="gem.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
  ...
  <div class="card" style="width:400px;margin:20px;">
    <img class="card-img-top" src="gc.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
  ...
  <div class="card" style="width:400px;margin:20px;">
    <img class="card-img-top" src="gdp.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
